        ...
        success: function (resp) {
          ...
          if (resp == 0) { 
            ...
            alertify.error('<b>Acceso denegado</b>');
                ...
                if (prefx == 'l') {
                    $('#head-result').append('<tr class="active"><th class=\'col-lg-1 text-center\'>C&oacute;digo</th><th class=\'col-lg-2 text-center\'>Autor</th><th class=\'col-lg-2 text-center\'>Editorial</th><th class=\'col-lg-2 text-center\'>Materia</th><th class=\'col-lg-3\'>Descripci&oacute;n</th><th class=\'col-lg-1 text-center\'>Disponibilidad</th><th class=\'col-lg-1 text-center\'>Fecha</th><th class=\'text-center col-lg-1\'>Solicitud(s)</th></tr>');
                } else if (prefx == 't') {
                    $('#head-result').append('<tr class="active"><th class=\'col-lg-1 text-center\'>C&oacute;digo</th><th class=\'col-lg-2 text-center\'>Materia</th><th class=\'col-lg-2 text-center\'>Autor</th><th class=\'col-lg-2\'>Titulo</th><th class=\'col-lg-1 text-center\'>Fecha Publicaci&oacute;n</th><th class=\'col-lg-1 text-center\'>Mensi&oacute;n</th><th class=\'text-center col-lg-1\'>Disponibilidad</th><th class=\'text-center col-lg-1\'>Solicitud(s)</th></tr>');
                } else if (prefx == 'm') {
                    $('#head-result').append('<tr class="active"><th class=\'col-lg-1 text-center\'>C&oacute;digo</th><th class=\'col-lg-2 text-center\'>Nombre</th><th class=\'col-lg-3\'>Descripci&oacute;n</th><th class=\'col-lg-1\'>Disponibilidad</th><th class=\'text-center col-lg-1\'>Solicitud(s)</th></tr>');
                }
            $.each(resp,function(index,array){
                var color = (array['status'] == 't')?'danger':'success';
                if (prefx == 'l') {
                    $('#content-result').append('<tr class="'+color+'"><td class=\'text-center\'>'+ array['id_libro'] +'</td><td class=\'text-center\'>'+ array['id_autor'].toUpperCase() +'</td><td class=\'text-center\'>'+ array['id_editorial'].toUpperCase() +'</td><td class=\'text-center\'>'+ array['id_materia'].toUpperCase() +'</td><td>'+ array['descripcion'].toUpperCase() +'</td><td class=\'text-center\'>'+ ((array['status'] == 't')?'DISPONIBLE':'<span class="text-danger">NO DISPONIBLE</span>') +'</td><td class=\'text-center\'>'+ array['fecha_publicacion'] +'</td><td class=\'text-center\'>'+((array['status'] == "t")?'<button onClick="location.href=\'?page=prestar_libro&id_libro='+array['id_libro']+'\';" class=\'btn btn-danger\'>Prestar&nbsp;&nbsp;<i class=\'glyphicon glyphicon-transfer\'></i></button>':'<button class=\'btn btn-success\'>Prestado&nbsp;&nbsp;<i class=\'glyphicon glyphicon-remove\'></i></button>')+'</td></tr>');
                } else if (prefx == 't') {
                    $('#content-result').append('<tr class="'+color+'"><td class=\'text-center\'>'+ array['id_tesis'] +'</td><td class=\'text-center\'>'+ array['id_materia'].toUpperCase() +'</td><td class=\'text-center\'>'+ array['id_autor_tesis'].toUpperCase() +'</td><td>'+ array['titulo'].toUpperCase() +'</td><td class=\'text-center\'>'+ array['fecha_publicacion'] +'</td><td class=\'text-center\'>'+ array['mension'].toUpperCase() +'</td><td class=\'text-center\'>'+ ((array['status'] == 't')?'DISPONIBLE':'<span class="text-danger">NO DISPONIBLE</span>') +'</td><td class=\'text-center\'>'+((array['status'] == 't')?'<button onClick="location.href=\'?page=prestar_tesis&id_tesis='+array['id_tesis']+'\';" class=\'btn btn-danger\'>Prestar&nbsp;&nbsp;<i class=\'glyphicon glyphicon-transfer\'></i></button></td></tr>':'<button class=\'btn btn-success\'>Prestado&nbsp;&nbsp;<i class=\'glyphicon glyphicon-remove\'></i></button></td></tr>')+'');
                } else if (prefx == 'm') {
                    $('#content-result').append('<tr class="'+color+'"><td class=\'text-center\'>'+ array['id_material'] +'</td><td class=\'text-center\'>'+ array['nombre'].toUpperCase() +'</td><td>'+ array['descripcion_tipo'].toUpperCase() +'</td><td class=\'text-center\'>'+ ((array['status'] == 't')?'DISPONIBLE':'<span class="text-danger">NO DISPONIBLE</span>') +'</td><td class=\'text-center\'>'+((array['status'] == 't')?'<button onClick="location.href=\'?page=prestar_material&id_material='+array['id_material']+'\';" class=\'btn btn-danger\'>Prestar&nbsp;&nbsp;<i class=\'glyphicon glyphicon-transfer\'></i></button></td></tr>':'<button class=\'btn btn-success\'>Prestado&nbsp;&nbsp;<i class=\'glyphicon glyphicon-remove\'></i></button></td></tr>')+'');
                }
            });
            $('#table-result').fadeIn();
...
<?php 
  if (isset($_GET['pres_cmp'])) {
    echo '<script>alertify.success("<b>Prestamo realizado con exito</b>");</script>';
  }
  if (isset($_GET['rec_not'])) {
    echo '<script>alertify.error("<b>Recurso no disponible</b>");</script>';
  }
?>